...
from config import MAIN_SERVER_PORT, MONITOR_SERVER_PORT, MEMORY_SERVER_PORT, TOOL_SERVER_PORT, USER_PLUGIN_SERVER_PORT
...
# --- All API endpoints have been moved to main_routers/ package ---
# The following routers handle all endpoints:
#   - config_router: /api/preferences, /api/config/*, /api/steam_language
#   - characters_router: /api/characters/*, /api/voices, /api/voice_clone
#   - live2d_router: /api/live2d/*, /api/models
#   - workshop_router: /api/steam/workshop/*
#   - memory_router: /api/memory/*
#   - pages_router: /, /{lanlan_name}, /l2d, /chara_manager, etc.
#   - websocket_router: /ws/{lanlan_name}, /api/proactive_chat, /api/notify_task_result
#   - agent_router: /api/agent/*
#   - system_router: /api/beacon/shutdown, /api/emotion_analysis, /api/steam/achievements
