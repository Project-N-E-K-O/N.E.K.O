...
const tutorialItems = [
  ...
  },
  {
    icon: CheckCircle2,
    title: '确认出牌后才生效',
    body: '每次只能确认一张牌。确认后会消耗卡面左上角的费用，并根据卡牌效果造成伤害、治疗、护盾或控制。',
  },
  {
    icon: Sparkles,
    title: 'Combo属性',
  ...
  },
  {
    icon: Zap,
    title: '能量与跳过',
    body: '能量不足时无法确认出牌。没有可用卡牌时会自动跳过，也可以在玩家回合手动点击跳过。',
  },
  {
    icon: BookOpen,
    title: '日志与Combo列表',
    body: '左侧能量下方可以打开战斗日志或Combo列表。Combo列表打开期间不会阻止拖拽和出牌，只能再次点击Combo列表按钮关闭。',
  },
]
