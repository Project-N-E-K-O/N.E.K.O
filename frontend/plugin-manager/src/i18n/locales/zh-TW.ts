...
export default {
  ...
  market: {
    ...
    login: '登入',
    loginStarted: '已為你開啟瀏覽器，請在開啟的頁面完成 Auth 登入授權。',
    loginSuccess: 'Auth 登入已連線，可以繼續使用外掛市集',
    loginFailed: 'Auth 登入尚未完成，請稍後再試',
    loginPending: 'Auth 授權等待時間有點久，請重新發起登入',
    logoutSuccess: '已在本機退出 Auth 登入',
    searchPlaceholder: '搜尋外掛...',
    notConfigured: '外掛市集未設定',
    configHint: '請將 NEKO_MARKET_API_URL 設定為外掛市集 API 位址',
    noResults: '找不到外掛',
