...
export default {
  ...
  market: {
    ...
    install: 'インストール',
    installed: 'インストール済み',
    marketVersion: 'マーケット v{version}',
    marketInstalledVersion: 'マーケット版 v{version}',
    localInstalledVersion: 'ローカル v{version} · {source}',
    useMarketVersion: 'マーケット版に切り替える',
    localVersionNewer: 'ローカル版の方が新しい',
    installing: 'インストール中...',
    installSuccess: 'インストールタスクを作成: {name}',
    installFailed: 'インストールに失敗しました',
    installPreparing: 'インストールを準備中...',
    installAlreadyRunning: '別のインストールが進行中です。完了するまでお待ちください。',
    externalInstallConfirmationTitle: 'マーケットからのインストールを確認',
    externalInstallConfirmationBody: 'プラグインマーケットが {id} v{version} の {mode} を要求しました。チャンネル: {channel}。ダウンロード元: {host}。SHA256: {sha256}。これらは要求元ページの申告値です。N.E.K.O はファイルを変更する前にパッケージを再検証します。続行しますか？',
  ...
  plugins: {
    ...
    runtimeVersion: {
      title: '実行バージョン',
      description: '複数のコードが利用できます。実際に実行するものを選択してください。',
      current: '使用中',
      useThisVersion: 'このバージョンを使用',
      builtinHint: 'N.E.K.O に同梱された組み込みコード',
      marketHint: 'プラグイン市場からインストールしたコード',
      importedHint: 'ローカルパッケージからインポートしたコード',
      localHint: 'ローカルまたは旧形式のプラグインコード',
      sharedDataHint: '切り替わるのは実行コードだけです。同じプラグイン ID の設定・データ・キャッシュは共有されます。',
      confirmTitle: '実行バージョンを切り替え',
      confirmBody: '{source} v{version} に切り替えます。実行中のプラグインは停止後、新しい選択で再起動します。ユーザーデータは削除されません。',
      confirmDowngradeBody: 'v{currentVersion} から古い{source} v{version} に切り替えます。古いコードが新しいユーザーデータを読めない可能性があります。続行しますか？',
      confirmAction: '切り替える',
      switchSucceeded: '実行バージョンを切り替えました',
      switchFailed: '切り替えに失敗しました。以前の実行バージョンへの復元を試みました。',
      unavailable: '実行バージョンを切り替えられません',
      unavailableHint: 'プラグインの出所情報が不完全か競合しています。更新して再試行してください。',
      blockedReason: '選択できません：{reason}',
    },
    ...
    batchDeleteConfirm: '選択した {count} 個のプラグインを削除または非表示にしますか？ユーザーがインストールしたコードは削除され、組み込みコードとプラグインデータは保持されます。',
    ...
    importSuccessRestartRequired: '{name} をインポートしました。実行中のプラグインを新しいバージョンへ切り替えるには N.E.K.O を再起動してください。',
    ...
    dangerDialog: {
      ...
      deleteMessage: '「{pluginName}」を削除するとアプリから取り除かれます。再インストールに備えて設定とデータは保持されます。',
  ...
  package: {
    install: {
      ...
      upgradeUnmanagedBody: 'このフォルダーはプラグインセンターが管理するインストールではなく、開発者のローカル変更を含む可能性があります。続行すると {current} を {target} に置き換え、コード、依存関係、パッケージ資産を上書きします。確認後にファイルが変更された場合、インストールは停止します。',
      upgradeConfirm: 'プラグインをアップグレード',
      upgradeCancelled: 'アップグレードをキャンセルしました。',
      upgradeSucceeded: '{plugin} を正常にアップグレードしました。',
      restartRequired: 'インストールが完了しました。新しいバージョンを使用するには N.E.K.O を再起動してください。',
      activationBlocked: 'プラグインを安全に有効化できなかったため、インストール成功として扱いません。理由: {reason}',
      ...
      error: {
        ...
        manifestInvalid: 'パッケージの manifest.toml が不正です。作者に修正と再ビルドを依頼してください。',
        ...
        packageTypeMismatch: '宣言されたパッケージ種別と収録プラグイン数が一致しません。作者に再ビルドを依頼してください。',
        hashMismatch: 'パッケージ内容が検証情報と一致しません。インストールは行われませんでした。',
        hashMismatchRolledBack: 'パッケージ内容が検証情報と一致しないため、取り込みを拒否し、インストール前の状態に戻しました。',
        packageStateConflict: '変更したプラグインデータが新しいバージョンと競合しています。現在のプラグインを復元しました。変更したファイルをバックアップしてから再試行してください。',
