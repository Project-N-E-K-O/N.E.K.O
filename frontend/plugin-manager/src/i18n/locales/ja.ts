...
export default {
  ...
  market: {
    ...
    login: 'ログイン',
    loginStarted: 'ブラウザを開きました。Auth で認可を完了してください。',
    loginSuccess: 'Auth ログインが接続されました',
    loginFailed: 'Auth ログインに失敗しました',
    loginPending: 'Auth 認可がタイムアウトしました。再試行してください',
    logoutSuccess: 'Auth からログアウトしました',
