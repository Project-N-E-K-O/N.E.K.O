...
export default {
  ...
  market: {
    ...
    login: 'ログイン',
    loginStarted: 'ブラウザを開きました。表示された画面で Auth のサインインを完了してください。',
    loginSuccess: 'Auth サインインが完了し、利用できる状態です',
    loginFailed: 'Auth サインインを完了できませんでした',
    loginPending: 'Auth サインインに時間がかかりすぎました。もう一度お試しください',
    logoutSuccess: 'この端末で Auth からサインアウトしました',
    searchPlaceholder: 'プラグインを検索...',
    notConfigured: 'プラグインマーケットが未設定',
    configHint: 'NEKO_MARKET_API_URL にプラグインマーケット API のアドレスを設定してください',
