...
export default {
  ...
  market: {
    ...
    login: '로그인',
    loginStarted: '브라우저를 열었습니다. 열린 화면에서 Auth 로그인을 마무리해 주세요.',
    loginSuccess: 'Auth 로그인이 연결되어 바로 사용할 수 있습니다',
    loginFailed: 'Auth 로그인을 완료하지 못했습니다',
    loginPending: 'Auth 로그인 시간이 너무 오래 걸렸습니다. 다시 시도해 주세요',
    logoutSuccess: '이 기기에서 Auth 로그아웃을 완료했습니다',
    searchPlaceholder: '플러그인 검색...',
    notConfigured: '플러그인 마켓이 설정되지 않음',
    configHint: 'NEKO_MARKET_API_URL에 플러그인 마켓 API 주소를 설정해 주세요',
