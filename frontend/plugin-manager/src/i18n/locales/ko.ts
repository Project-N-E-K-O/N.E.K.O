...
export default {
  ...
  market: {
    ...
    login: '로그인',
    loginStarted: '브라우저를 열었습니다. Auth에서 인증을 완료하세요.',
    loginSuccess: 'Auth 로그인이 연결되었습니다',
    loginFailed: 'Auth 로그인 실패',
    loginPending: 'Auth 인증 시간이 초과되었습니다. 다시 시도하세요',
    logoutSuccess: 'Auth에서 로그아웃했습니다',
