...
export default {
  ...
  mirrorSource: {
    title: '미러 소스', description: '플러그인 마켓에서 GitHub Release 패키지를 다운로드할 연결 방식을 선택합니다.', close: '미러 소스 닫기', proxyOptional: 'GitHub Proxy (선택 사항)', direct: 'GitHub 직접 연결', auto: '자동 속도 측정 선택', specified: '프록시 지정', source: '미러 소스', testing: '측정 중…', autoFastest: '가장 빠름: {source}', autoUnavailable: '최근 측정에서 사용 가능한 노드가 없어 GitHub 직접 연결을 사용합니다.', autoPending: '아직 측정하지 않았으며 임시로 GitHub 직접 연결을 사용합니다.', testAndSelect: '속도 측정 후 가장 빠른 소스 선택', recentResults: '최근 측정 결과', notice: 'github.com 플러그인 다운로드 링크만 프록시하며 패키지는 계속 Market의 SHA-256으로 검증합니다.', activeSource: '현재 소스: {source}', unavailable: '연결 실패 또는 시간 초과', noAvailable: '사용 가능한 GitHub 다운로드 소스가 없어 GitHub 직접 연결을 사용합니다.', selectedFastest: '가장 빠른 소스를 선택했습니다: {source}', testFailed: '미러 소스 속도 측정 실패', installFallback: '미러 소스 측정에 실패하여 GitHub 직접 연결을 사용합니다.'
  },
  plugins: {
    title: '플러그인 목록',
    name: '플러그인 이름',
