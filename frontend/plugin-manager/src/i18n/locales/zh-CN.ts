...
export default {
  ...
  market: {
    ...
    login: '登录',
    loginStarted: '已为你打开浏览器，请在打开的页面里完成 Auth 登录授权。',
    loginSuccess: 'Auth 登录已连接，可以继续使用插件市场',
    loginFailed: 'Auth 登录没有完成，请稍后再试',
    loginPending: 'Auth 授权等待时间有点久，请重新发起登录',
    logoutSuccess: '已在本机退出 Auth 登录',
    searchPlaceholder: '搜索插件...',
    notConfigured: '插件市场未配置',
    configHint: '请将 NEKO_MARKET_API_URL 设置为插件市场 API 地址',
    noResults: '没有找到插件',
