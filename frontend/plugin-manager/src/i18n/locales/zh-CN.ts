...
export default {
  ...
  market: {
    ...
    login: '登录',
    loginStarted: '已打开浏览器，请在 Auth 完成授权。',
    loginSuccess: 'Auth 登录已连接',
    loginFailed: 'Auth 登录失败',
    loginPending: 'Auth 授权超时，请重试',
    logoutSuccess: '已退出 Auth 登录',
    searchPlaceholder: '搜索插件...',
    notConfigured: '插件市场未配置',
    configHint: '请在环境变量中设置 NEKO_MARKET_API_URL',
    noResults: '没有找到插件',
