...
export default {
  ...
  common: {
    surfaceLanguagePending: "Язык приложения изменён. Язык панели сохранён, чтобы не потерять несохранённые данные.",
    surfaceApplyLanguage: "Применить язык и перезагрузить панель",

    languageLoading: "Загрузка языка; интерфейс доступен",
    languageLoadFailed: "Не удалось загрузить язык. Текущий язык сохранён.",
    languageRetry: "Повторить загрузку",
    languageReload: "Обновить страницу",
