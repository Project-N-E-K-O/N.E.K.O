...
export default {
  ...
  market: {
    ...
    login: 'Войти',
    loginStarted: 'Браузер открыт. Завершите вход через Auth в открывшемся окне.',
    loginSuccess: 'Вход через Auth подключён и готов к работе',
    loginFailed: 'Не удалось завершить вход через Auth',
    loginPending: 'Вход через Auth занял слишком много времени. Попробуйте ещё раз.',
    logoutSuccess: 'Вы вышли из Auth на этом устройстве',
    searchPlaceholder: 'Поиск плагинов...',
    notConfigured: 'Маркет не настроен',
    configHint: 'Укажите в NEKO_MARKET_API_URL адрес API маркета плагинов',
