...
export default {
  ...
  market: {
    ...
    login: 'Войти',
    loginStarted: 'Браузер открыт. Завершите авторизацию в Auth.',
    loginSuccess: 'Вход в Auth подключен',
    loginFailed: 'Не удалось войти в Auth',
    loginPending: 'Авторизация Auth истекла; попробуйте снова',
    logoutSuccess: 'Вы вышли из Auth',
