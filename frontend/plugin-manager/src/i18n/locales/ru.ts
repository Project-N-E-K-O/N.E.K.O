...
export default {
  ...
  market: {
    ...
    installDetails: 'Подробности',
    installDetailsHide: 'Скрыть подробности',
  ...
  pluginUpdates: {
    ...
    titleWithCount: 'Обновления плагинов ({count})',
    checking: 'Проверяем обновления…',
    refresh: 'Обновить',
    close: 'Закрыть',
    dragHint: 'Перетащите, чтобы переместить',
    allUpToDate: 'Все плагины обновлены',
    checkIncomplete: 'Не удалось проверить часть плагинов. Подробности — в журнале сервера.',
    update: 'Обновить',
    updating: 'Обновление…',
    updateAll: 'Обновить все',
    updateAllProgress: 'Обновление {done}/{total}',
    updateSucceeded: 'Обновлено: {name}',
    manualRequired: 'Обновите этот плагин на странице магазина',
  },
  settings: {
