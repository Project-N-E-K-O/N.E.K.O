...
export default {
  ...
  market: {
    ...
    login: 'Login',
    loginStarted: "We've opened your browser. Please finish signing in with Auth there.",
    loginSuccess: 'Auth sign-in is connected and ready to use',
    loginFailed: 'Auth sign-in did not go through',
    loginPending: 'Auth sign-in took too long. Please try opening it again.',
    logoutSuccess: "You've signed out of Auth on this device",
    searchPlaceholder: 'Search plugins...',
    notConfigured: 'Plugin market not configured',
    configHint: 'Set NEKO_MARKET_API_URL to the plugin market API address',
