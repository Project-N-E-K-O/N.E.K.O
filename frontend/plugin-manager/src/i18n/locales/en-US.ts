...
export default {
  ...
  market: {
    ...
    login: 'Login',
    loginStarted: 'Browser opened. Complete authorization in Auth.',
    loginSuccess: 'Auth login connected',
    loginFailed: 'Auth login failed',
    loginPending: 'Auth authorization timed out; try again',
    logoutSuccess: 'Logged out of Auth',
    searchPlaceholder: 'Search plugins...',
    notConfigured: 'Plugin market not configured',
    configHint: 'Set NEKO_MARKET_API_URL environment variable',
