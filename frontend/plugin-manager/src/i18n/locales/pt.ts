 ...
 */
export default {
  modelApi: modelApiMessages['pt'],
  modelBindings: modelBindingsMessages['pt'],
  development: {
  ...
  market: {
    ...
    installStep: {
      ...
      verify: 'Verificação',
      install: 'Instalação',
      replace: 'Substituição de arquivos',
      rollback: 'Reversão',
      completed: 'Concluído',
    },
    installDetails: 'Detalhes',
    installDetailsHide: 'Ocultar detalhes',
  ...
  pluginUpdates: {
    ...
    buttonBusy: 'Verificando…',
    title: 'Atualizações de plugins',
    titleWithCount: 'Atualizações de plugins ({count})',
    checking: 'Verificando atualizações…',
    refresh: 'Atualizar',
    close: 'Fechar',
    dragHint: 'Arraste para mover',
    allUpToDate: 'Todos os plugins estão atualizados',
    checkIncomplete: 'Não foi possível verificar alguns plugins. Consulte os registros do servidor.',
    update: 'Atualizar',
    updating: 'Atualizando…',
    updateAll: 'Atualizar tudo',
    updateAllProgress: 'Atualizando {done}/{total}',
    updateSucceeded: 'Atualizado: {name}',
    manualRequired: 'Atualize este plugin na página do mercado',
  },
  settings: {
