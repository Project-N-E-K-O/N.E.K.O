...
export default {
  ...
  mirrorSource: {
    title: 'Fonte espelho', description: 'Escolha como o Plugin Market baixa pacotes do GitHub Release.', close: 'Fechar fonte espelho', proxyOptional: 'GitHub Proxy (opcional)', direct: 'GitHub direto', auto: 'Escolher automaticamente o mais rápido', specified: 'Escolher um proxy', source: 'Fonte', testing: 'Testando…', autoFastest: 'Mais rápido: {source}', autoUnavailable: 'Nenhuma fonte ficou disponível no último teste; usando GitHub direto.', autoPending: 'Ainda não testado; o GitHub direto será usado temporariamente.', testAndSelect: 'Testar e escolher a fonte mais rápida', recentResults: 'Resultados do último teste', notice: 'Apenas links de download de plugins de github.com usam proxy; o pacote continua validado pelo SHA-256 do Market.', activeSource: 'Fonte atual: {source}', unavailable: 'Indisponível ou tempo esgotado', noAvailable: 'Nenhuma fonte de download do GitHub ficou disponível; usando GitHub direto.', selectedFastest: 'Fonte mais rápida selecionada: {source}', testFailed: 'Falha no teste da fonte espelho', installFallback: 'Falha no teste da fonte espelho; usando GitHub direto.'
  },
  plugins: {
    title: 'Plugins',
    name: 'Nome do plugin',
