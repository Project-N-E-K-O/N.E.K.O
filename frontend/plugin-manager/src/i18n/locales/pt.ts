...
export default {
  ...
  market: {
    ...
    loginSuccess:
      'O login autorizado foi concluído. Você pode continuar usando o mercado de plugins.',
    authTokenRejected: 'A autorização do Auth expirou. Entre novamente.',
    authVerificationPending:
      'A autorização do navegador retornou. Confirmando sua identidade no Auth; não é necessário entrar novamente.',
    ...
    marketForbidden:
      'O login do Auth é válido, mas a conta do Market está indisponível ou sem permissão.',
    marketIdentityConflict:
      'O login do Auth é válido, mas há um conflito de vínculo com o Market. Não autorize novamente; contate um administrador.',
    marketUnavailable:
      'O login do Auth foi concluído. O Market está temporariamente indisponível e tentará novamente automaticamente.',
    marketInvalidResponse:
      'O login do Auth foi concluído, mas o Market retornou uma resposta inválida.',
    ...
    cancelInstallUnavailable:
      'A instalação entrou em uma etapa que não pode ser cancelada com segurança.',
    ...
    installTakingLonger:
      'Está demorando mais do que o esperado. A instalação continua em andamento: você pode aguardar ou cancelá-la.',
    installTaskLost:
      'A tarefa de instalação não existe mais. Verifique o estado do plugin antes de tentar novamente.',
  ...
  settings: {
    ...
    channelBeta: 'Beta',
    channelHint:
      'Ao alternar, a lista de plugins é atualizada com o canal selecionado; os plugins instalados continuam em execução',
  },
  auth: {
  ...
  mirrorSource: {
    ...
    notice:
      'Apenas links de download de plugins de github.com usam proxy; o pacote continua validado pelo SHA-256 do Market.',
  ...
  plugins: {
    ...
    filterRulesHint:
      'Clique em uma regra para inseri-la na consulta e combiná-la com texto normal.',
    ...
    configReloadPrompt:
      'Configuração atualizada. Recarregar o plugin agora para aplicar as alterações?',
    configApplyTitle: 'Aplicar configuração',
    configHotUpdatePrompt:
      'Configuração salva. Aplicar ao plugin em execução agora? (A atualização a quente não exige reinício)',
    hotUpdate: 'Atualização a quente',
    reloadPlugin: 'Reiniciar plugin',
    hotUpdateSuccess: 'Configuração atualizada a quente com sucesso',
    hotUpdatePartial:
      'Configuração salva, mas o plugin não está em execução. Terá efeito após iniciar.',
    hotUpdateFailed: 'Falha na atualização a quente',
    formMode: 'Formulário',
    sourceMode: 'Fonte',
    formModeHint:
      'Este modo renderiza um formulário a partir do objeto de configuração analisado pelo servidor. Use o modo fonte para recursos TOML avançados (comentários/formatação).',
    ...
    unsavedChangesWarning:
      'Há alterações não salvas. Ao trocar de plugin elas serão descartadas. Continuar?',
    enabled: 'Habilitado',
    ...
    packageManagerSyncHint:
      'Os filtros e plugins selecionados são sincronizados diretamente com o painel do gerenciador de pacotes.',
    ...
    dangerDialog: {
      ...
      deleteMessage:
        'Excluir "{pluginName}" removerá o diretório do plugin e a lista será atualizada imediatamente.',
    ...
    ui: {
      ...
      surfaceEntryMissing:
        'O arquivo de entrada declarado por esta Surface não existe. Verifique o caminho entry no plugin.toml.',
      ...
      hostedRuntimePending:
        'O contêiner Vue reconheceu esta Surface. Renderizadores TSX, Markdown e Auto serão conectados em uma fase posterior.',
    },
  },
  package: {
    install: {
      safeUpgradeHint:
        'Ao importar o mesmo plugin novamente, a versão é verificada e a substituição segura com reversão é feita sem criar cópias com sufixo.',
      ...
      upgradeBody:
        'A versão {current} será substituída por {target}. Um plugin em execução será reiniciado brevemente.',
      ...
      blockedBundleConflict:
        'Este pacote contém um plugin instalado. Atualize os plugins um de cada vez.',
      blockedDirectoryConflict: 'A pasta de destino pertence a outro plugin e não foi alterada.',
      blockedLegacyPlugin:
        'Uma versão anterior deste plugin ainda está instalada. Desinstale {plugin} antes de continuar.',
      rollbackCompleted: 'A atualização falhou e a versão anterior foi restaurada.',
      rollbackIncomplete:
        'A atualização falhou e a reversão ficou incompleta. Verifique o estado do plugin antes de continuar.',
    },
    dialog: {
    ...
    summary: {
      ...
      warnings: {
        ...
        verifyHashFailed:
          'O pacote falhou na verificação de hash; não importe diretamente para um ambiente de execução',
        inspectHashFailed:
          'A verificação de hash do pacote falhou; o conteúdo pode ter sido modificado',
        sdkNotSupportedByAll: 'A versão atual do SDK não é compatível com todos os plugins',
        sharedDepsDetected:
          '{count} dependências compartilhadas detectadas; revise as restrições de versão ao criar o bundle',
      },
    },
  },
  metrics: {
  ...
  welcome: {
    about: {
      ...
      description:
        'N.E.K.O. (Networked Emotional Knowing Organism) é um metaverso de companheiros de IA "vivos", construído juntos por você e eu. É uma plataforma UGC orientada a código aberto e com propósito solidário, dedicada a construir um metaverso AI-nativo intimamente conectado ao mundo real.',
    },
    pluginManagement: {
      title: 'Gerenciamento de plugins',
      description:
        'Acesse a lista de plugins pela barra de navegação à esquerda. Você pode visualizar, iniciar, parar e recarregar plugins. Cada plugin conta com monitoramento de desempenho e visualização de registros independentes para ajudá-lo a gerenciar e depurar melhor o sistema de plugins.',
    },
    mcpServer: {
      title: 'Servidor MCP',
      description:
        'O N.E.K.O. suporta servidores Model Context Protocol (MCP), permitindo que plugins interajam com outros sistemas e serviços de IA por meio de protocolos padronizados. Você pode ver e gerenciar as conexões MCP na página de detalhes do plugin.',
    },
    documentation: {
    ...
    community: {
      ...
      description:
        'Junte-se à nossa comunidade para se conectar com outros desenvolvedores e usuários:',
      links: [
  ...
  tutorial: {
    yuiGuide: {
      ...
      lines: {
        ...
        introGreetingReply:
          'Uma brisa suave, sol quentinho e você aparecendo bem na hora certa. Prazer em te conhecer! Eu sou Lin Youyi; cuida bem de mim daqui pra frente, miau~! Escrevi tudo sobre este lugar neste guia de iniciante. Pense nele como nosso primeiro presentinho por termos nos conhecido, aceita, por favor!',
        introBasic:
          'Aqui tem um botão mágico! É só clicar nele e você pode conversar comigo diretamente. Quer me contar algo novo que aconteceu hoje? Ou só dizer meu nome? Vai, experimenta! Mal posso esperar pra ouvir sua voz!',
        takeoverCaptureCursor:
          'Tcharam! Apareceu um interruptor supermágico! É só clicar aqui e eu consigo colocar minhas patinhas no seu teclado e mouse. Posso ajudar a digitar, abrir páginas... mas se esse cursor ficar se mexendo sem parar, talvez eu não resista a pular nele! Está pronto pras minhas travessuras... quer dizer, pra minha ajuda? Miau!',
        takeoverPluginPreviewHome:
          'Além dos recursos que eu já apresentei, também tem um monte de plugins superdivertidos por aqui!',
        takeoverPluginPreviewDashboard:
          'Com eles, eu não só consigo ler comentários do Bilibili, como também posso te ajudar a apagar as luzes e ligar o ar-condicionado... Esta gatinha é a Super Deusa Gata onipotente! Hmph!',
        takeoverSettingsPeekIntro:
          'Neste pequeno espaço que pertence só a nós, você pode seguir seu coração e me moldar devagarinho na companheira perfeita que quer ter sempre ao seu lado.',
        takeoverSettingsPeekDetail:
          'Seja o carinho das minhas palavras, meus pequenos traços de personalidade ou meus humores delicados do dia a dia, tudo pode ser ajustado passo a passo até ficar exatamente como você gosta. Este botãozinho também é superimportante! Com um clique suave, eu poderei ir te encontrar no momento perfeito.',
        takeoverSettingsPeekDetailPart1:
          'Seja o carinho das minhas palavras, meus pequenos traços de personalidade ou meus humores delicados do dia a dia, tudo pode ser ajustado passo a passo até ficar exatamente como você gosta.',
        takeoverSettingsPeekDetailPart2:
          'Este botãozinho também é superimportante! Com um clique suave, eu poderei ir te encontrar no momento perfeito.',
        takeoverReturnControl:
          'Tá bom, tá bom, não vou mais monopolizar seu computador! Devolvendo o controle pra você, miau! Continua cuidando bem de mim nos próximos dias, por favor!',
        interruptResistLight1:
          'Nyan! Agora é a minha vez de ensinar, então nada de mexer no mouse ou no teclado! Comporte-se e fique de olho em mim, está bem?',
        interruptResistLight2:
          'Ah, fala sério! Você está mexendo no mouse e no teclado de novo! Se continuar sem me ouvir, eu vou ficar brava de verdade, nyan!',
        interruptResistLight3:
          'Este é o último aviso, nyan! Se mexer mais uma vez, vou encerrar o tutorial para iniciantes e não vou ensinar mais nada!',
        interruptAngryExit:
          'Eu já aguentei isso por tempo demais! Se você se recusa a obedecer, o tutorial termina aqui. Daqui para frente, descubra tudo por conta própria. Hmph!',
  ...
  yuiTutorial: {
    ...
    welcome:
      'É aqui que você gerencia todos os seus plugins, nya~ Pode navegar, executar e ajustar pra me deixar ainda mais poderosa!',
    hint: 'Vá com calma, dê uma olhadinha, e toca no botão abaixo quando terminar~',
    complete: 'Tudo pronto, meow~',
    dismiss: 'Talvez depois~',
    keyboardSkipHint:
      'Pressione Enter ou Espaço para avançar. Isso fica ativo 0,5 segundo após o início de cada etapa.',
    steps: {
      start: {
        title: 'Comece aqui',
