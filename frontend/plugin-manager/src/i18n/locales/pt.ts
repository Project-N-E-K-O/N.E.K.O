...
export default {
  ...
  market: {
    ...
    login: 'Entrar',
    loginStarted: 'Navegador aberto. Conclua a autorização no Auth.',
    loginSuccess: 'Login do Auth conectado',
    loginFailed: 'Falha no login do Auth',
    loginPending: 'A autorização do Auth expirou; tente novamente',
    logoutSuccess: 'Sessão do Auth encerrada',
    searchPlaceholder: 'Buscar plugins...',
    notConfigured: 'Mercado não configurado',
    configHint: 'Defina a variável de ambiente NEKO_MARKET_API_URL',
