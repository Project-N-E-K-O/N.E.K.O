...
export default {
  ...
  market: {
    ...
    login: 'Entrar',
    loginStarted: 'Abrimos o navegador. Conclua o login com Auth por lá.',
    loginSuccess: 'O login do Auth está conectado e pronto para uso',
    loginFailed: 'Não foi possível concluir o login do Auth',
    loginPending: 'O login do Auth demorou demais. Tente abrir novamente.',
    logoutSuccess: 'Você saiu do Auth neste dispositivo',
    searchPlaceholder: 'Buscar plugins...',
    notConfigured: 'Mercado não configurado',
    configHint: 'Defina NEKO_MARKET_API_URL com o endereço da API do mercado de plugins',
  ...
  tutorial: {
    yuiGuide: {
      ...
      lines: {
        ...
        interruptResistLight1: "Ei! Não puxa, ainda não é sua vez!",
        interruptResistLight3: "Espera um pouquinho! Ainda não acabou, não me interrompe assim sem cuidado!",
        interruptAngryExit: "Humano! Você é supermal-educado, miau! Já que quer tanto controlar tudo sozinho, então vai brincar por conta própria com essa tela fria e sem vida! Hmph!",
