...
export default {
  development: {
    guidePurpose: "Esta interface não desenvolve plugins por você com um clique. Ela ajuda a empacotar código existente em plugins importáveis com um clique e a continuar o desenvolvimento.",
    navTitle: "Plugins em desenvolvimento",
    guideButton: "Guia de uso",
    guideTitle: "Comece a desenvolver seu plugin",
    guideIntro: "Vincule sua pasta de código para desenvolver, depurar e empacotar plugins sem clonar o repositório principal do N.E.K.O.",
    guideLoadTitle: "Carregue o código-fonte",
    guideLoadBody: "Ative o modo de desenvolvimento, escolha uma pasta com plugin.toml, valide e carregue. Os caminhos inseridos no navegador pertencem à máquina do servidor.",
    guideReloadTitle: "Edite e recarregue",
    ...
    previewHint: "Valide a pasta para conferir os detalhes do plugin antes de carregá-lo.",
    title: "Modo de desenvolvimento",
    load: "Carregar plugin descompactado",
    hint: "Carregue o código-fonte desenvolvido para empacotar e importar o plugin ou continuar o desenvolvimento.",
    badge: "Em desenvolvimento",
    entry: "Ponto de entrada",
    openSource: "Abrir pasta de código",
    start: "Iniciar",
    stop: "Parar",
    reload: "Recarregar",
    logs: "Logs",
    build: "Criar pacote",
    rebind: "Alterar pasta",
    remove: "Remover vínculo",
    pathHint: "Digite a pasta de código na máquina que executa o backend N.E.K.O. O envio de pastas pelo navegador não é compatível.",
    path: "Pasta de código",
    choose: "Escolher pasta",
    valid: "Validação concluída",
    validate: "Validar",
    failed: "Falha na operação",
    built: "Pacote criado. Os testes funcionais e a revisão do mercado são etapas separadas.",
