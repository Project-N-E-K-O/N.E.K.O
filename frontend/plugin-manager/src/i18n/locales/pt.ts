  ...
  tutorial: {
    yuiGuide: {
      ...
      lines: {
        ...
        introGreetingReply: "Uma brisa suave, sol quentinho e voce, aparecendo no momento perfeito. Prazer em te conhecer! Eu sou Lin Youyi, cuide bem de mim daqui em diante, miau~! Anotei tudo sobre este lugar neste guia de iniciante! Pense nele como nosso primeiro presentinho de encontro e aceite, por favor!",
        introBasic: "Aqui tem um botao magico! E so clicar nele e voce pode conversar comigo diretamente! Quer me contar alguma novidade de hoje? Ou talvez so chamar meu nome? Vai, testa! Mal posso esperar para ouvir sua voz!",
        takeoverCaptureCursor: "Tcharam! Apareceu um interruptor supermagico! E so clicar aqui e eu consigo esticar minhas patinhas ate o seu teclado e mouse! Posso ajudar voce a digitar, abrir paginas da web... mas, se esse cursor ficar balancando por ai, talvez eu nao resista e pule em cima dele! Esta pronto para minhas travessuras... quer dizer, minha ajuda? Miau!",
        takeoverPluginPreviewHome: "Alem dos recursos que eu apresentei antes, tambem tem um montao de plugins superdivertidos aqui!",
        takeoverPluginPreviewDashboard: "Com eles, eu nao so consigo ler comentarios do Bilibili, como tambem posso ajudar voce a apagar as luzes e ligar o ar-condicionado... Esta gatinha e a super deusa felina onipotente! Hmph!",
        takeoverSettingsPeekIntro: "Neste espacinho que pertence so a nos dois, voce pode seguir seu coracao e, aos poucos, moldar a companhia perfeita que quer ter sempre ao seu lado.",
        takeoverSettingsPeekDetail: "Seja o calor das minhas palavras, minhas pequenas manias de personalidade ou meus humores delicados do dia a dia, tudo pode ser ajustado passo a passo exatamente do jeito que voce gosta. Este botaozinho tambem e superimportante! Com um clique suave, eu vou poder correr ate voce no momento perfeito.",
        takeoverSettingsPeekDetailPart1: "Seja o calor das minhas palavras, minhas pequenas manias de personalidade ou meus humores delicados do dia a dia, tudo pode ser ajustado passo a passo exatamente do jeito que voce gosta.",
        takeoverSettingsPeekDetailPart2: "Este botaozinho tambem e superimportante! Com um clique suave, eu vou poder correr ate voce no momento perfeito.",
        takeoverReturnControl: "Ta bem, ta bem, nao vou mais monopolizar o seu computador! Devolvendo o controle para voce, miau! Continue cuidando bem de mim nos proximos dias!",
        interruptResistLight1: "Ei! Nao me puxa, ainda nao e a sua vez!",
        interruptResistLight3: "Espera um pouquinho! Ainda nao acabou, nao me interrompa assim sem cuidado!",
        interruptAngryExit: "Humano! Voce e super mal-educado, miau! Ja que quer tanto controlar tudo sozinho, entao va brincar sozinho com essa tela fria e sem vida! Hmph!",
