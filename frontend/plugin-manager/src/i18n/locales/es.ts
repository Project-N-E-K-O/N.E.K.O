  ...
  tutorial: {
    yuiGuide: {
      ...
      lines: {
        ...
        interruptResistLight1: "Hey! Don't tug on me, it's not your turn yet!",
        interruptResistLight3: "Wait a minute! It's not over yet, don't interrupt me so carelessly!",
        interruptAngryExit: "Human! You are super impolite, meow! Since you want to control everything yourself so badly, go ahead and play by yourself with that cold, lifeless screen! Hmph!",
