...
export default {
  ...
  market: {
    ...
    loginStarted: 'Hemos abierto el navegador. Termina el inicio de sesión con Auth allí.',
    loginSuccess: 'El inicio de sesión con Auth está conectado y listo para usar',
    loginFailed: 'No se pudo completar el inicio de sesión con Auth',
    loginPending: 'El inicio de sesión con Auth tardó demasiado. Inténtalo de nuevo.',
    logoutSuccess: 'Has cerrado la sesión de Auth en este dispositivo',
    searchPlaceholder: 'Buscar plugins...',
    notConfigured: 'Mercado no configurado',
    configHint: 'Define NEKO_MARKET_API_URL con la dirección de la API del mercado de plugins',
