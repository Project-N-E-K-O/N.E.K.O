...
export default {
  ...
  market: {
    ...
    loginStarted: 'Navegador abierto. Complete la autorización en Auth.',
    loginSuccess: 'Inicio de sesión de Auth conectado',
    loginFailed: 'Error al iniciar sesión en Auth',
    loginPending: 'La autorización de Auth expiró; inténtelo de nuevo',
    logoutSuccess: 'Sesión de Auth cerrada',
