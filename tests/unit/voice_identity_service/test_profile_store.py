...
def test_v3_uses_versioned_authenticated_data() -> None:
    assert store_module._SCHEMA_VERSION == 5
    assert store_module._AAD == b"N.E.K.O.voice-identity.profile\x00v5"
    assert store_module._READ_AAD[4] == b"N.E.K.O.voice-identity.profile\x00v4"
