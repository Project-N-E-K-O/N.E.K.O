...
def test_strip_proactive_screen_tag_leak_removes_known_prefix_leaks():
    cases = [
        ...
        ("屏幕画面/这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("屏幕画面／这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("/屏幕画面/这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("／屏幕画面／这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("当前屏幕内容/这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("/当前屏幕内容/这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("当前屏幕截图/这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("／当前屏幕截图／这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("屏幕截图/这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("当前画面/这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("画面内容/这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("当前窗口/这个窗口有点怪", "这个窗口有点怪", "CHAT"),
        ("/画面很好看", "/画面很好看", ""),
        ("画面/音乐都做得很棒", "画面/音乐都做得很棒", ""),
        (
