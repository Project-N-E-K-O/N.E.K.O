...
def test_goodbye_composer_hidden_syncs_to_chat_window():
    ...
    assert "yuiGuideInterpageResources.addEventListener(window, 'neko:config-injected', postStandaloneChatStateRequests);" in interpage_source
    assert "yuiGuideInterpageResources.addEventListener(window, 'neko:request-goodbye-chat-composer-hidden-state'" in interpage_source
    assert "yuiGuideInterpageResources.addEventListener(window, 'focus', function ()" in interpage_source
    assert "yuiGuideInterpageResources.addEventListener(document, 'visibilitychange', function ()" in interpage_source
    assert (
