...
@pytest.mark.unit
async def test_main_server_proactive_chat_respond_renders_without_passthrough(monkeypatch):
    """Chat visibility renders verbatim while respond independently reaches AI."""
    from app import main_server
