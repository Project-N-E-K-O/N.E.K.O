...
def test_avatar_floating_tutorial_copy_uses_csv_i18n_columns():
    samples = {
        "tutorial.yuiGuide.lines.introBasic": {
            ...
            "ja": "ここに不思議なボタンがあるよ！これをクリックするだけで、私と直接おしゃべりできちゃうんだ。今日あった楽しいことを教えてくれる？それとも、ただ名前を呼んでくれるのかな？早く試してみて、もう君の声を聞くのが待ちきれないよ！",
            ...
            "ko": "여기 신기한 버튼이 있어요! 이걸 누르면 저랑 바로 대화할 수 있답니다! 오늘 있었던 신기한 일을 들려줄래요? 아니면 그냥 제 이름을 불러줄래요? 얼른 해봐요, 당신의 목소리가 너무너무 듣고 싶단 말이에요!",
        },
