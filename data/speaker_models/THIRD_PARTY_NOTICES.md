...
The release artifact includes an ONNX export of the following third-party
speaker-verification model. The weight itself is downloaded during a formal
build and is not stored in this Git repository. Its immutable byte identity is
