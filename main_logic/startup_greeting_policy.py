...
# Built-in ordinary openings. ``time_greeting`` is preferred on a fresh burst so
# startup speaks one time-of-day line (早上好 / 中午好 / 晚上好…) instead of
# stacking a time cue with another opening angle.
