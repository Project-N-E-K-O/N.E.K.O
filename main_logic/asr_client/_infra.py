...
# Local CPU Whisper can lag several seconds behind realtime; keep enough
# headroom so a slow first encode does not immediately trip
# ASR_INGRESS_BACKPRESSURE / ASR_STREAM_BACKPRESSURE.
_REQUEST_QUEUE_SIZE = 64
_ACTIVE_QUEUE_MAX_AUDIO_MS = 8_000
_ACTIVE_QUEUE_MAX_AUDIO_BYTES = _ACTIVE_QUEUE_MAX_AUDIO_MS * 16_000 * 2 // 1_000
_ACTIVE_QUEUE_MAX_AUDIO_ITEMS = 512
_REQUEST_BACKPRESSURE_TIMEOUT_SECONDS = 5.0
