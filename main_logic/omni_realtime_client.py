...
class OmniRealtimeClient:
    ...
    def _build_turn_detector(self):
        ...
        try:
            ...
            VAD_SPEECH_MIN_MS, VAD_SILENCE_MS = 200, 300
            SMART_TURN_THRESHOLD, VAD_HARD_COMMIT_SILENCE_MS = 0.5, 2500
    ...
    async def _activate_local_turn_if_available(self) -> None:
        ...
        ok_silero = await asyncio.to_thread(det.silero.load)
        ok_smart = await asyncio.to_thread(det.smart_turn.load)
        if ok_silero:
