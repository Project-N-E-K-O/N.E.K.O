...
Live2DManager.prototype._createCharacterSettingsSidePanel = function () {
    const container = this._createSidePanelContainer();
    container.style.flexDirection = 'column';
    container.style.alignItems = 'stretch';
    container.style.gap = '2px';
...
// 创建侧边面板中的菜单项
Live2DManager.prototype._createSidePanelMenuItem = function (item) {
    const menuItem = document.createElement('div');
    menuItem.id = `live2d-sidepanel-${item.id}`;
...
Live2DManager.prototype._createSettingsMenuItems = function (popup) {
    ...
    characterSettingsBtn.id = 'live2d-menu-character';
