...
function getWorkshopReservedFields() {
    ...
    const extraSystemFields = ['live2d_item_id', '_reserved', 'item_id', 'idleAnimation', 'idleAnimations']
...
function getWorkshopHiddenFields() {
    const cfg = _getReservedConfigOrFallback();
    const keySystemFields = ['live2d', 'system_prompt', 'voice_id', 'live2d_item_id', '_reserved', 'item_id', 'idleAnimation', 'idleAnimations'];
