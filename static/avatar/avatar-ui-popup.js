    ...
    apply: function (ManagerProto, prefix, options = {}) {
        ...
        ManagerProto._createSettingsMenuItems = function (popup) {
            ...
            const settingsItems = [
                ...
                { id: 'voice-identity', label: window.t ? window.t('settings.menu.voiceIdentity') : '声纹身份', labelKey: 'settings.menu.voiceIdentity', icon: '/static/icons/microphone_icon.png', action: 'navigate', url: '/voice_identity' },
