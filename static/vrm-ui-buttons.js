...
VRMManager.prototype.setupFloatingButtons = function () {
    ...
    buttonConfigs.forEach(config => {
        ...
        Object.assign(btn.style, {
            width: '48px', height: '48px', borderRadius: '50%', background: 'var(--neko-btn-bg)',
            backdropFilter: 'saturate(180%) blur(20px)', border: 'var(--neko-btn-border)',
            display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px',
            cursor: 'pointer', userSelect: 'none', boxShadow: 'var(--neko-btn-shadow)',
        ...
        if (config.iconOff && config.iconOn) {
            ...
            btn.addEventListener('mouseenter', () => {
                ...
                btn.style.background = 'var(--neko-btn-bg-hover)';
            ...
            btn.addEventListener('mouseleave', () => {
                ...
                btn.style.background = shouldShowOnIcon ? 'var(--neko-btn-bg-active)' : 'var(--neko-btn-bg)';
                if (imgOff && imgOn) {
            ...
            btn.addEventListener('click', (e) => {
                ...
                btn.style.background = targetActive ? 'var(--neko-btn-bg-active)' : 'var(--neko-btn-bg-hover)';
            });
        }
        ...
        if (config.hasPopup && config.separatePopupTrigger) {
            ...
            Object.assign(triggerBtn.style, {
                ...
                background: 'var(--neko-btn-bg)', backdropFilter: 'saturate(180%) blur(20px)',
                border: 'var(--neko-btn-border)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                cursor: 'pointer', userSelect: 'none',
                boxShadow: 'var(--neko-btn-shadow)', transition: 'all 0.1s ease', pointerEvents: 'auto',
                marginLeft: '-10px'
            });
    ...
    Object.assign(returnBtn.style, {
        width: '64px', height: '64px', borderRadius: '50%', background: 'var(--neko-btn-bg)',
        backdropFilter: 'saturate(180%) blur(20px)', border: 'var(--neko-btn-border)',
        display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer',
        boxShadow: 'var(--neko-popup-shadow)', transition: 'all 0.1s ease', pointerEvents: 'auto', position: 'relative'
    });
