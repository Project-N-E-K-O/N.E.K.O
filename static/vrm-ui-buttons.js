...
VRMManager.prototype.setupFloatingButtons = function () {
    ...
    buttonConfigs.forEach(config => {
        ...
        if (config.id === 'mic' && config.hasPopup && config.separatePopupTrigger) {
            const muteBtn = document.createElement('div');
            muteBtn.id = 'vrm-btn-mic-mute';
            muteBtn.className = 'vrm-floating-btn vrm-mic-mute-btn';
            ...
            this._floatingButtons['mic-mute'] = {
                button: muteBtn,
                svg: muteSvg,
                micPath: micPath,
                micStand: micStand,
