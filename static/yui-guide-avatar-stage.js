(function () {
    ...
    const INTRO_GREETING_HUG_APPROACH_MS = 1500;
    ...
    function computeIntroGreetingHugPose(progress, context) {
        ...
        return {
            ...
            yuiLeftWaveSwitch: 0,
            yuiRightForearmAnim: 0.84 * hugWeight,
            yuiLeftForearmAnim: 0.84 * hugWeight,
            yuiRightHandAnim: 0.62 * hugWeight,
            yuiLeftHandAnim: 0.62 * hugWeight,
            yuiRightHandWave: 0,
            yuiLeftHandWave: 0,
            frameScale: 1 + (frameScale - 1) * hugWeight,
            frameY: frameY * hugWeight
        };
    }
    ...
    class Live2DIntroGreetingHugSession {
        ...
        applyPose(pose, weight) {
            ...
            this.writeWeighted('yuiRightWaveSwitch', 0, w * (YUI_INTRO_GREETING_HUG_POSE_BLEND_FACTORS.yuiRightWaveSwitch || 1));
            this.writeWeighted('yuiLeftWaveSwitch', 0, w * (YUI_INTRO_GREETING_HUG_POSE_BLEND_FACTORS.yuiLeftWaveSwitch || 1));
            ...
            this.writeWeighted('yuiRightHandWave', 0, w * (YUI_INTRO_GREETING_HUG_POSE_BLEND_FACTORS.yuiRightHandWave || 1));
            this.writeWeighted('yuiLeftHandWave', 0, w * (YUI_INTRO_GREETING_HUG_POSE_BLEND_FACTORS.yuiLeftHandWave || 1));
        }
