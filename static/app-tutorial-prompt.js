(function () {
    ...
    const FLOW_LOG_PREFIX_FALLBACK = '[TutorialPromptFlow]';
    ...
    function shortTutorialRunToken(tutorialRunToken) {
        if (!tutorialRunToken) return 'none';
        return String(tutorialRunToken).slice(0, 8);
    }
    ...
    function fireAndForgetJson(url, payload) {
        ...
        try {
            ...
            console.warn('[TutorialPrompt] sendBeacon failed:', error);
        }
