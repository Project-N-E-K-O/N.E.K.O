...
(function () {
    ...
    // 空气投篮新增了完整文案键，主动搭话新增了喵宇宙社区来源的 key；递增版本让
    // Electron、Docker 等长期缓存重新拉取完整语言包，避免把新 key 当字面量显示。
    const LOCALE_VERSION = '2026-09-14-proactive-community-air-basketball';
