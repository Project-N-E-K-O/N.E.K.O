...
(function () {
    ...
    // 插件 HTML 卡片与 AgentHUD 新增了提示 key，并合入 main 上 Plugin API 设置入口与
    // 主动搭话社区来源的 key；递增版本让 Electron、Docker 等长期缓存重新拉取完整语言包，
    // 避免界面显示原始 key。
    const LOCALE_VERSION = '2026-09-22-plugin-html-content-main-merge';
