...
(function () {
    ...
    window.renderFloatingMicList = async function (popupArg) {
        ...
        try {
            ...
            Object.assign(leftColumn.style, { flex: '0 0 100%', width: '100%', minWidth: '0', maxWidth: '100%', display: 'flex', flexDirection: 'column', overflowY: 'auto' });
            ...
            async function openScreenSourceSubwindow() {
                ...
                panel.appendChild(screenSourceList);
                positionMicSubwindow(panel);
            ...
            leftColumn.insertBefore(micActionButton, leftColumn.firstChild);
            leftColumn.appendChild(createMainActionButton('\uD83D\uDDA5\uFE0F', screenButtonLabel, window.t ? window.t('app.screenSource.screens') : 'Screens', openScreenSourceSubwindow));
