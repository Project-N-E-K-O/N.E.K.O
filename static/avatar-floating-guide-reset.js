            ...
            steps: [
                {
                    ...
                    selector: '#react-chat-window-root .send-button-circle.compact-input-tool-toggle',
                    text: '高亮新版胶囊工具总按钮，点击并打开弧形工具菜单。',
                ...
                },
                {
                    ...
                    selector: '#react-chat-window-root .compact-input-tool-item-avatar',
                    text: '停留在 Avatar 互动工具，播放完后再次触发该按钮点击事件。',
                ...
                },
                {
                    ...
                    selector: '#react-chat-window-root .send-button-circle.compact-input-tool-toggle',
                    text: '模拟滑动弧形菜单，直到 Galgame 按钮出现在右偏下位置。',
