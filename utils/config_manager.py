...
class ConfigManager:
    ...
    def get_core_config(self):
        ...
        config['ASSIST_API_KEY_MINIMAX'] = core_cfg.get('assistApiKeyMinimax', '') or _fb('minimax')
        config['ASSIST_API_KEY_MINIMAX_INTL'] = core_cfg.get('assistApiKeyMinimaxIntl', '') or _fb('minimax_intl')
