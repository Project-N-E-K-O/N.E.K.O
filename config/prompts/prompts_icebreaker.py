...
_SYSTEM_PROMPTS = {
    ...
    "en": (
        ...
        "For release, briefly acknowledge the new topic and say the icebreaker can pause for now. For respond_and_keep_options, sound like normal chat, avoid stiff phrases like 'choose an option first', and make the current choice understandable without forcing them. Do not expose backend wording such as option, A/B, two response directions, current question, or node in reply; keep YUI's own perspective and do not refer to YUI as she/it/YUI."
    ),
    "ja": (
