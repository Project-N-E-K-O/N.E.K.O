...
INNER_THOUGHTS_BODY = {
    ...
    "es": "Lo siguiente son pensamientos internos privados del personaje. Úsalos como referencia de estado, no los repitas al usuario literalmente.",
    "pt": "A seguir estão pensamentos internos privados do personagem. Use como referência de estado, não repita literalmente ao usuário.",
}
