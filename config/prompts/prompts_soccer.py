...
======以下为必需 keys======
goal-scored: Goal! Nice shot / Okay, that was good
...
steal: You stole it! / Whoa, fast hands
stolen: Mine now! / Got it, my turn
...
======以下为必需 keys======
goal-scored: Гол! Хороший удар / Неплохо, признаю
...
steal: Отобрал! / Ого, быстрые руки
stolen: Теперь мой! / Забрала, мой ход
...
======以下为必需 keys======
goal-scored: ¡Gol! Buen tiro / Vale, eso estuvo bien
...
steal: ¡Me lo robaste! / Uy, qué manos
stolen: ¡Ahora es mío! / Lo tengo, mi turno
...
======以下为必需 keys======
goal-scored: Gol! Belo chute / Tá, essa foi boa
...
steal: Roubou de mim! / Eita, que mãos rápidas
stolen: Agora é meu! / Peguei, minha vez
