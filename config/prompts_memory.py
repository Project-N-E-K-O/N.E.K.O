...
你的摘要应该保留关键信息、重要事实和主要讨论点，且不能具有误导性或产生歧义，不得超过800字。
...
Your summary should preserve key information, important facts, and main discussion points without being misleading or ambiguous. It must not exceed 800 words.
...
要約には重要な情報、事実、主な議論のポイントを保持し、誤解を招いたり曖昧にならないようにしてください。800字を超えないでください。
...
요약에는 핵심 정보, 중요한 사실, 주요 논의 사항을 보존해야 하며, 오해를 일으키거나 모호해서는 안 됩니다. 800자를 초과하면 안 됩니다.
...
Резюме должно сохранять ключевую информацию, важные факты и основные обсуждаемые темы, при этом не вводить в заблуждение и не быть двусмысленным. Не более 800 слов.
