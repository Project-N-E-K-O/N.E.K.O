...
# GPT-SoVITS WebSocket defaults (used when TTS_MODEL is gpt-sovits)
DEFAULT_GPT_SOVITS_WS_URL = ""
DEFAULT_GPT_SOVITS_TEXT_LANG = "zh"
DEFAULT_GPT_SOVITS_PROMPT_LANG = "zh"
DEFAULT_GPT_SOVITS_PROMPT_TEXT = ""
DEFAULT_GPT_SOVITS_REF_AUDIO_PATH = ""
DEFAULT_GPT_SOVITS_AUX_REF_AUDIO_PATHS: list[str] = []
DEFAULT_GPT_SOVITS_SPEAKER = ""
DEFAULT_GPT_SOVITS_MEDIA_TYPE = "raw"
DEFAULT_GPT_SOVITS_SAMPLE_RATE = 32000
DEFAULT_GPT_SOVITS_SPEED = 1.0
DEFAULT_GPT_SOVITS_FRAGMENT_INTERVAL = 0.3
DEFAULT_GPT_SOVITS_TEXT_SPLIT_METHOD = "cut5"
DEFAULT_GPT_SOVITS_TOP_K = 5
DEFAULT_GPT_SOVITS_TOP_P = 1.0
DEFAULT_GPT_SOVITS_TEMPERATURE = 1.0
DEFAULT_GPT_SOVITS_BATCH_SIZE = 1
DEFAULT_GPT_SOVITS_BATCH_THRESHOLD = 0.75
DEFAULT_GPT_SOVITS_SPLIT_BUCKET = True
DEFAULT_GPT_SOVITS_REPETITION_PENALTY = 1.35
DEFAULT_GPT_SOVITS_EXTRA_PAYLOAD: dict = {}
...
DEFAULT_CORE_CONFIG = {
    ...
    "ttsModelApiKey": "",
    "ttsVoiceId": "",
    "gptSovitsWsUrl": DEFAULT_GPT_SOVITS_WS_URL,
    "gptSovitsTextLang": DEFAULT_GPT_SOVITS_TEXT_LANG,
    "gptSovitsPromptLang": DEFAULT_GPT_SOVITS_PROMPT_LANG,
    "gptSovitsPromptText": DEFAULT_GPT_SOVITS_PROMPT_TEXT,
    "gptSovitsRefAudioPath": DEFAULT_GPT_SOVITS_REF_AUDIO_PATH,
    "gptSovitsAuxRefAudioPaths": DEFAULT_GPT_SOVITS_AUX_REF_AUDIO_PATHS,
    "gptSovitsSpeaker": DEFAULT_GPT_SOVITS_SPEAKER,
    "gptSovitsMediaType": DEFAULT_GPT_SOVITS_MEDIA_TYPE,
    "gptSovitsSampleRate": DEFAULT_GPT_SOVITS_SAMPLE_RATE,
    "gptSovitsSpeed": DEFAULT_GPT_SOVITS_SPEED,
    "gptSovitsFragmentInterval": DEFAULT_GPT_SOVITS_FRAGMENT_INTERVAL,
    "gptSovitsTextSplitMethod": DEFAULT_GPT_SOVITS_TEXT_SPLIT_METHOD,
    "gptSovitsTopK": DEFAULT_GPT_SOVITS_TOP_K,
    "gptSovitsTopP": DEFAULT_GPT_SOVITS_TOP_P,
    "gptSovitsTemperature": DEFAULT_GPT_SOVITS_TEMPERATURE,
    "gptSovitsBatchSize": DEFAULT_GPT_SOVITS_BATCH_SIZE,
    "gptSovitsBatchThreshold": DEFAULT_GPT_SOVITS_BATCH_THRESHOLD,
    "gptSovitsSplitBucket": DEFAULT_GPT_SOVITS_SPLIT_BUCKET,
    "gptSovitsRepetitionPenalty": DEFAULT_GPT_SOVITS_REPETITION_PENALTY,
    "gptSovitsExtraPayload": DEFAULT_GPT_SOVITS_EXTRA_PAYLOAD,
}
