...
DEFAULT_ASSIST_API_PROFILES = {
    ...
    'qwen': {
        ...
        '文本对话模型_MODEL' : "qwen3-235b-a22b-instruct-2507",
    ...
    'openai': {
        ...
        '文本对话模型_MODEL' : "gpt-5-chat-latest",
    ...
    'silicon': {
        ...
        '文本对话模型_MODEL' : "deepseek-ai/DeepSeek-V3.2" ,
    ...
    'gemini': {
        ...
        '文本对话模型_MODEL' : "gemini-3-flash-preview",
