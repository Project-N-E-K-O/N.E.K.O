...
_CJK_ALIAS_NEGATION_RE = re.compile(
    ...
    r"不(?:觉得|覺得|认为|認為)(?:它|牠|这|這|这个|這個|那|那个|那個)?是?)"
...
_ALIAS_NEGATION_SUFFIXES = (
    "じゃない", "じゃなかった", "じゃありません",
    "ではない", "ではなかった", "ではありません",
    "이 아니야", "가 아니야", "은 아니야", "는 아니야", "아니야",
    "이 아니에요", "가 아니에요", "은 아니에요", "는 아니에요", "아니에요",
    "이 아니라", "가 아니라", "은 아니라", "는 아니라", "아니라",
    "이 아니다", "가 아니다", "은 아니다", "는 아니다", "아니다",
    "이 아닙니다", "가 아닙니다", "은 아닙니다", "는 아닙니다", "아닙니다",
    "이 아닌데", "가 아닌데", "은 아닌데", "는 아닌데", "아닌데",
    "지 않아", "지 않다", "지 않습니다", "지 않은데",
)
