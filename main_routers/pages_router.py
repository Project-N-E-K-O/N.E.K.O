...
_REACT_CHAT_ASSET_VERSION_PATHS = (
    ...
    *_PROJECT_ROOT.glob("static/app/app-react-chat-window/*.js"),
    ...
    _PROJECT_ROOT / "static/assets/avatar-tools/ui/edit_tool_unified.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/sugar/chat_sugar1.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/sugar/chat_sugar2.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/sugar/chat_sugar3.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/sugar/chat_sugar1_cursor.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/sugar/chat_sugar2_cursor.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/claw/cat_claw1.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/claw/cat_claw2.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/claw/cat_claw1_cursor.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/claw/cat_claw2_cursor.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/hammer/chat_hammer1.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/hammer/chat_hammer2.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/hammer/chat_hammer1_cursor.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/hammer/chat_hammer2_cursor.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/rps/rps_rock.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/rps/rps_scissors.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/rps/rps_paper.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/rps/rps_rock_cursor.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/rps/rps_scissors_cursor.png",
    _PROJECT_ROOT / "static/assets/avatar-tools/rps/rps_paper_cursor.png",
)
