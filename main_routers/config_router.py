...
async def get_steam_language():
    ...
    try:
        ...
        i18n_language = STEAM_TO_I18N_MAP.get(steam_language, 'en')
...
async def update_core_config(request: Request):
    ...
    try:
        ...
        config_fields = [
            'coreApi', 'assistApi', 'assistApiKeyQwen', 'assistApiKeyOpenai',
            ...
            'ttsModelProvider', 'ttsModelUrl', 'ttsModelId', 'ttsModelApiKey',
        ]
        ...
        # Notify clients and reset sessions
...
@router.get("/config/api_providers")
