...
def import_pngtube_remix_model(package_dir: Path, remix_file: Path, fallback_model_name: str) -> dict:
    ...
    warnings = [
        "PNGTubeRemix project was imported through layered_canvas_v1. Speech, blink, hotkeys, and layered physics are supported; mesh data is preserved as metadata for later runtime support."
    ]
    ...
    return {
        ...
        "message": "PNGTubeRemix model imported with layered adapter v1. Speech, blink, hotkeys, and layered physics are enabled; mesh data is preserved for future support.",
        "warnings": warnings,
    }
