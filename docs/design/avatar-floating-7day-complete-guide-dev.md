...
| 3 | `day3_tool_toggle_intro` | 否；当前探身从 `day3_avatar_tools` 开始。 |
...
2. `static/yui-guide-avatar-standin.test.cjs` 必须断言 `day2_intro_context`、`day5_character_settings`、`day7_memory_review` 不再返回探身 cue，同时保留 `day2_proactive_chat`、`day3_avatar_tools`、`day3_galgame_entry`、`day4_gaze_follow`、`day4_privacy_mode`、`day6_plugin_dashboard`、`day6_agent_task_hud` 等非第一句 cue。
