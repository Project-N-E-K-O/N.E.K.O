...
- 页面模板：`templates/*.html`。
- 首页与聊天前端：`static/app-*.js`、`static/*ui-buttons.js`、`static/yui-guide-*.js`、`static/universal-tutorial-manager.js`、`static/avatar-floating-guide-reset.js`、`frontend/react-neko-chat/src/*`。
...
- 首页 YUI 苏醒教程：`static/yui-guide-steps.js`、`static/yui-guide-wakeup.js`。
- 模型旁悬浮窗教程：`static/yui-guide-director.js`，当前 4 日骨架，目标 7 日。
