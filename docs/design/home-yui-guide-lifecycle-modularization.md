...
2. `static/tutorial-highlight-controller.js`
3. `static/tutorial-interrupt-controller.js`
4. `static/tutorial-skip-controller.js`
...
- 模块文件：`static/tutorial-highlight-controller.js`
- 当前接入方：`static/yui-guide-director.js`
...
<script src="/static/tutorial-highlight-controller.js"></script>
...
真正的遮罩 cutout、圆形 frame、矩形 frame 仍由 `static/yui-guide-overlay.js` 读取这些属性后统一渲染。
