...
7. animated WebP 由 `yui-guide-petal-1.png` 和 `yui-guide-petal-2.png` 预生成：花瓣从模型中心出发，先大幅向右形成弧线，再向左铺开并从页面左边消失，同时保留噪声摆动和翻滚旋转；新版资源把起点收得更紧、花瓣单体进一步缩小，让前段看起来更小更密，随后在时间轴后半段逐渐放大并把扩散范围拉开，让尾段变得更稀松。
