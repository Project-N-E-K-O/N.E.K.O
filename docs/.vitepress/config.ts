...
function pluginsSidebar(lang: 'en' | 'zh-CN' | 'ja') {
  const t = {
    en: {
      ...
      journey: 'Getting Started', quick: 'Quick Start', toml: 'Plugin Config (plugin.toml)',
      entries: 'Entries & Parameters', lifecycleCfg: 'Lifecycle & Config',
    ...
    'zh-CN': {
      ...
      journey: '旅程的起点', quick: '快速开始', toml: '插件配置 (plugin.toml)',
      entries: '入口与参数', lifecycleCfg: '生命周期与配置',
      sdk: 'SDK 参考', dec: '装饰器', ex: '示例', adv: '进阶话题',
      hosted: 'Hosted UI', tool: 'LLM Tool Calling', best: '最佳实践',
    },
    ja: {
      group: 'プラグイン開発', overview: '概要',
      journey: 'はじめの一歩', quick: 'クイックスタート', toml: 'プラグイン設定 (plugin.toml)',
      entries: 'エントリーとパラメータ', lifecycleCfg: 'ライフサイクルと設定',
