...
function pluginsSidebar(lang: 'en' | 'zh-CN' | 'ja') {
  const t = {
    en: {
      ...
      journey: 'Getting Started', quick: 'Quick Start', cli: 'Plugin CLI', base: 'Plugin Capabilities',
    ...
    'zh-CN': {
      ...
      journey: '旅程的起点', quick: '快速开始', cli: '插件 CLI', base: '插件能力',
    ...
    ja: {
      ...
      journey: 'はじめの一歩', quick: 'クイックスタート', cli: 'プラグイン CLI', base: 'プラグイン機能',
