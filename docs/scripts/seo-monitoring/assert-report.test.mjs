...
function segment(id) {
  ...
  return {
    ...
    target: {
      ...
      serpLanguageCode: definition.serpLanguageCode,
      volumeLanguageCode: definition.volumeLanguageCode,
      keywordDifficultyLanguageCode: definition.keywordDifficultyLanguageCode,
      device: 'desktop',
    },
