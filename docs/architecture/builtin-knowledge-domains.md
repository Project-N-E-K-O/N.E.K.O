...
PR2 bundles 229 selected records from `dariusk/corpora`, pinned to commit
...
character memory files. This PR also does not connect `app/`, `main_logic/`,
management routes, or plugin-market transport.
