...
def _render_verify_workflow(spec: PluginSpec) -> str:
    return _MARKET_ACTIONS_MANAGED_HEADER + f'''name: Verify N.E.K.O Plugin
...
def _render_release_workflow(spec: PluginSpec) -> str:
    return _MARKET_ACTIONS_MANAGED_HEADER + f'''name: Release N.E.K.O Plugin
...
def _render_ruff_config() -> str:
    ...
    return _MARKET_ACTIONS_MANAGED_HEADER + '''target-version = "py311"
line-length = 120
