...
def export_pngtuber_model(
    ...
    *,
    ...
    return {
        ...
        "message": f"Exported NEKO PNGTuber v2 package with {len(rows)} layer(s)",
        "warning": "This is a NEKO PNGTuber v2 package, not a Cubism model3/moc3 package.",
    }
    ...
    *,
    ...
    return {
        ...
        "notes": [
            ...
            "The package targets NEKO PNGTuber v2 runtime.",
            "Only neutral emotion is declared because generated layers do not contain authored expression variants.",
...
It is an importable NEKO PNGTuber v2 package using the `{NEKO_PNGTUBER_ADAPTER}` adapter.
