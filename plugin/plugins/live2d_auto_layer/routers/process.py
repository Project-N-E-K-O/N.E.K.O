...
class ProcessRouter(PluginRouter):
    ...
    @plugin_entry(
        ...
        description=tr(
            ...
            default="Generate an importable NEKO PNGTuber v2 ZIP with model.json, metadata.neko-pngtuber.v2.json, ordered PNG layers, explicit emotion metadata, and fallback composite images. This is not a Cubism model3/moc3 package.",
        ),
        input_schema={
            "type": "object",
            "properties": {
    ...
    @plugin_entry(
        ...
        description=tr(
            ...
            default="Export a session as NEKO PNGTuber v2 and install it into the user PNGTuber model library.",
        ),
        input_schema={
            "type": "object",
            "properties": {
