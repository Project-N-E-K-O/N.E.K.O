...
| Tipo | Color del borde izquierdo | Descripción |
|------|--------------------------|-------------|
...
|-------------|-----|-------------------------|
| Buscar vídeos | Buscar vídeos por palabra clave | Palabra clave |
...
| Ranking | Ranking de una categoría específica | Orden/categoría (`all`/`game`/`dance`, etc.) |
| Información del vídeo | Obtener detalles del vídeo | BV |
| Comentarios del vídeo | Obtener la lista de comentarios del vídeo | BV |
| Subtítulos del vídeo | Obtener subtítulos generados por AI | BV |
| Danmaku histórico | Obtener el historial de danmaku del vídeo | BV |
| Información del usuario | Obtener el perfil del usuario | UID |
| Subidas del usuario | Obtener la lista de vídeos subidos por el usuario | UID |
| Lista de favoritos | Obtener la lista de carpetas de favoritos del usuario | UID |
| Contenido de favoritos | Obtener los vídeos dentro de una carpeta de favoritos | media_id de favoritos |
...
| Herramienta | Uso | Parámetros obligatorios |
|-------------|-----|-------------------------|
| Publicar comentario/respuesta | Comentar bajo un vídeo o responder a un comentario | BV + contenido del comentario; las respuestas requieren además el rpid del comentario |
| Publicar publicación | Publicar una nueva publicación (dinámica) | Texto de la publicación (admite imágenes) |
| Enviar mensaje privado | Enviar un mensaje privado a un usuario | UID del destinatario + contenido del mensaje |
