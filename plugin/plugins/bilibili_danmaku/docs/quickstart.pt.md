...
| Tipo | Cor da borda esquerda | Descrição |
|------|------------------------|-----------|
...
|-----------|-----|-------------------------|
| Buscar vídeos | Buscar vídeos por palavra-chave | Palavra-chave |
...
| Ranking | Ranking de uma categoria específica | Ordem/categoria (`all`/`game`/`dance` etc.) |
| Informações do vídeo | Obter detalhes do vídeo | BV |
| Comentários do vídeo | Obter a lista de comentários do vídeo | BV |
| Legendas do vídeo | Obter legendas geradas por AI | BV |
| Histórico de danmaku | Obter o histórico de danmaku do vídeo | BV |
| Informações do usuário | Obter o perfil do usuário | UID |
| Envios do usuário | Obter a lista de vídeos enviados pelo usuário | UID |
| Lista de favoritos | Obter a lista de pastas de favoritos do usuário | UID |
| Conteúdo dos favoritos | Obter os vídeos dentro de uma pasta de favoritos | media_id da pasta |
...
| Ferramenta | Uso | Parâmetros obrigatórios |
|-----------|-----|-------------------------|
| Publicar comentário/resposta | Comentar em um vídeo ou responder a um comentário | BV + conteúdo do comentário; respostas requerem também o rpid do comentário |
| Publicar postagem | Publicar uma nova postagem (dinâmica) | Texto da postagem (com imagens opcionais) |
| Enviar mensagem direta | Enviar uma DM a um usuário | UID do destinatário + conteúdo da mensagem |
