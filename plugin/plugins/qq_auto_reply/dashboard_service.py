    ...
    async def build_dashboard_state(self) -> dict[str, Any]:
        ...
        return {
            ...
            "settings": {
                ...
                "attention_base_rise_rate": float(settings.get("attention_base_rise_rate", 0.02) or 0.02),
                "attention_message_boost": float(settings.get("attention_message_boost", 0.15) or 0.15),
                "attention_keyword_boost_ratio": float(settings.get("attention_keyword_boost_ratio", 1.8) or 1.8),
                "attention_honeymoon_seconds": int(settings.get("attention_honeymoon_seconds", 60) or 60),
                "attention_fall_seconds": int(settings.get("attention_fall_seconds", 30) or 30),
                "attention_fall_rate": float(settings.get("attention_fall_rate", 0.015) or 0.015),
                "attention_consume_ratio": float(settings.get("attention_consume_ratio", 0.10) or 0.10),
