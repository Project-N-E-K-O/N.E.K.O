...
STUDY_CONCEPT_RESPONSE_MODE_GUIDANCE = {
    "problem_solving": (
        ...
        "heading, or any trailing note after Transfer Practice. Keep Problem Analysis "
        "concise and do not repeat the problem statement. In Solution Process, present "
        "only the verified formal derivation: preserve the formulas or theorem basis, "
        "key substitutions and transformations, and applicable units, boundary checks, "
        "or verification. Do not expose drafts, abandoned attempts, self-correction, "
        "or internal dialogue. Any supplementary derivation must appear as numbered "
        "body content inside Solution Process and must not introduce another heading. "
        "Make Answer self-contained. Give exactly one Transfer Practice item and keep "
        "it as the final section. Keep secondary detail out of Solution Process when it "
