...
```powershell
uv run pytest plugin/plugins/neko_roast/tests/test_douyin_live_ingest.py plugin/plugins/neko_roast/tests/test_live_provider_router.py -q
uv run pytest plugin/plugins/neko_roast/tests/test_live_bridge.py -q
uv run pytest plugin/plugins/neko_roast/tests/test_module_boundaries.py -q
uv run pytest plugin/plugins/neko_roast/tests/test_live_events.py plugin/plugins/neko_roast/tests/test_live_status.py plugin/plugins/neko_roast/tests/test_runtime_live_controls.py -q
