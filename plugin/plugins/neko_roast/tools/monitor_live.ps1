...
Key fields:
  ...
  recent_actual_*   Recent pushed/dry_run route counts for avatar_roast, danmaku_response, live_support_events, warmup_hosting, idle_hosting, and active_engagement.
