"""Static live-content materials for NEKO Live.

Keep this module free of runtime state so content variety can be reviewed
without touching the scheduler or pipeline.
"""
