...
class CosplayConfig:
    ...
    def __init__(
        ...
        *,
        ...
        vision: CosplayVisionConfig | None = None,
        ...
        **legacy_fields: Any,
        ...
        self.vision = vision if vision is not None else CosplayVisionConfig()
