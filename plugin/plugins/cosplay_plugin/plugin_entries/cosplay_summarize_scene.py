...
class _CosplaySummarizeSceneMixin:
    @plugin_entry(
        id="cosplay_summarize_scene",
        name=tr("entries.cosplay_summarize_scene.name", default='总结当前场景'),
        description=tr("entries.cosplay_summarize_scene.description", default='总结当前场景或指定 scene_id 的最近剧情进展。'),
        input_schema={
            "type": "object",
    ...
    async def cosplay_summarize_scene(self, scene_id: str = "", **_):
