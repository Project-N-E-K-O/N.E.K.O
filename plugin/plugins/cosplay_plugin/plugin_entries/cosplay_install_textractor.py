...
class _CosplayInstallTextractorMixin:
    @plugin_entry(
        id="cosplay_install_textractor",
        name=tr("entries.cosplay_install_textractor.name", default='安装 Textractor'),
        description=tr("entries.cosplay_install_textractor.description", default='检测并下载安装 TextractorCLI.exe，随后刷新 cosplay_plugin 的桥接与读内存状态。'),
        input_schema={
            "type": "object",
            "properties": {
    ...
    async def cosplay_install_textractor(self, force: bool = False, **_):
