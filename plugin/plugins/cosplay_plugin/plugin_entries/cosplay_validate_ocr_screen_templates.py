...
class _CosplayValidateOcrScreenTemplatesMixin:
    @plugin_entry(
        id="cosplay_validate_ocr_screen_templates",
        name=tr("entries.cosplay_validate_ocr_screen_templates.name", default='验证 OCR 屏幕模板'),
        description=tr("entries.cosplay_validate_ocr_screen_templates.description", default='用当前 OCR 运行时和最近文本回放验证屏幕模板命中结果。'),
        input_schema={
            "type": "object",
            "properties": {
                "screen_templates": {
    ...
    async def cosplay_validate_ocr_screen_templates(
        self,
