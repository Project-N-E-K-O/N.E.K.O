...
class _GalgameBindGameMixin:
    @plugin_entry(
        id="cosplay_bind_game",
        name=tr("entries.cosplay_bind_game.name", default='绑定 cosplay 游戏'),
        description=tr("entries.cosplay_bind_game.description", default='绑定指定 game_id；传空字符串清除手动绑定并恢复自动选择。'),
        input_schema={
            "type": "object",
    ...
    async def cosplay_bind_game(self, game_id: str, **_):
