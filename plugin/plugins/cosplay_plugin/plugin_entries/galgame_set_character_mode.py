...
class _GalgameSetCharacterModeMixin:
    @plugin_entry(
        id="cosplay_set_character_mode",
        name=tr(
            "entries.cosplay_set_character_mode.name",
            default="设置角色档案模式",
        ),
        description=tr(
            "entries.cosplay_set_character_mode.description",
    ...
    async def cosplay_set_character_mode(
        self,
        mode: str,
        character_name: str = "",
        **_,
