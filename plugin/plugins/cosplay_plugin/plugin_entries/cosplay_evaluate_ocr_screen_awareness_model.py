...
class _CosplayEvaluateOcrScreenAwarenessModelMixin:
    @plugin_entry(
        id="cosplay_evaluate_ocr_screen_awareness_model",
        name=tr("entries.cosplay_evaluate_ocr_screen_awareness_model.name", default='评估 OCR 屏幕感知模型'),
        description=tr("entries.cosplay_evaluate_ocr_screen_awareness_model.description", default='用已标注 JSONL 样本评估轻量屏幕感知模型，并可输出评估报告。'),
        input_schema={
            "type": "object",
            "properties": {
    ...
    async def cosplay_evaluate_ocr_screen_awareness_model(
        self,
        sample_path: str = "",
