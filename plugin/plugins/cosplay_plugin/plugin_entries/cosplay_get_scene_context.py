...
class _CosplayGetSceneContextMixin:
    @plugin_entry(
        id="cosplay_get_scene_context",
        name=tr(
            "entries.cosplay_get_scene_context.name",
            default="查询场景上下文",
        ),
        description=tr(
            "entries.cosplay_get_scene_context.description",
    ...
    async def cosplay_get_scene_context(
        self,
        scene_id: str = "",
        **_,
    ):
        ...
        throttled = self._check_query_rate_limit("cosplay_get_scene_context")
