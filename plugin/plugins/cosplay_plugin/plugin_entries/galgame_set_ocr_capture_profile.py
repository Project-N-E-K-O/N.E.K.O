...
class _GalgameSetOcrCaptureProfileMixin:
    @plugin_entry(
        id="cosplay_set_ocr_capture_profile",
        name=tr("entries.cosplay_set_ocr_capture_profile.name", default='设置 OCR 截图校准'),
        description=tr("entries.cosplay_set_ocr_capture_profile.description", default='按进程名保存或清除 OCR Reader 的截图裁剪配置。'),
        input_schema={
            "type": "object",
            "properties": {
    ...
    async def cosplay_set_ocr_capture_profile(
        self,
        process_name: str = "",
