...
class _CosplayExplainLineMixin:
    @plugin_entry(
        id="cosplay_explain_line",
        name=tr("entries.cosplay_explain_line.name", default='解释当前或指定台词'),
        description=tr("entries.cosplay_explain_line.description", default='对当前快照或指定 line_id 对应的台词进行解释。'),
        input_schema={
            "type": "object",
    ...
    async def cosplay_explain_line(self, line_id: str = "", **_):
