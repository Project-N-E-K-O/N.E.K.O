...
class _CosplaySetMemoryReaderTargetMixin:
    @plugin_entry(
        id="cosplay_set_memory_reader_target",
        name=tr("entries.cosplay_set_memory_reader_target.name", default='设置 Memory Reader 目标进程'),
        description=tr("entries.cosplay_set_memory_reader_target.description", default='锁定或清除 Memory Reader 的手动进程目标。'),
        input_schema={
            "type": "object",
            "properties": {
    ...
    async def cosplay_set_memory_reader_target(
        self,
        process_key: str = "",
        pid: int = 0,
        exe_path: str = "",
