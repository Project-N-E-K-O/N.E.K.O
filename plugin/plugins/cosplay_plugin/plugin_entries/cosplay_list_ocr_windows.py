...
class _CosplayListOcrWindowsMixin:
    @plugin_entry(
        id="cosplay_list_ocr_windows",
        name=tr("entries.cosplay_list_ocr_windows.name", default='列出 OCR 候选窗口'),
        description=tr("entries.cosplay_list_ocr_windows.description", default='返回当前 OCR Reader 的可选窗口，可选包含只读排除列表。'),
        input_schema={
            "type": "object",
            "properties": {
    ...
    async def cosplay_list_ocr_windows(
        self,
