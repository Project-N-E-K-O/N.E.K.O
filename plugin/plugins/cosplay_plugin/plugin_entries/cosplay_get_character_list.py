...
class _CosplayGetCharacterListMixin:
    @plugin_entry(
        id="cosplay_get_character_list",
        name=tr(
            "entries.cosplay_get_character_list.name",
            default="查询当前游戏角色列表",
        ),
        description=tr(
            "entries.cosplay_get_character_list.description",
    ...
    async def cosplay_get_character_list(self, **_):
