...
from plugin.plugins.cosplay_plugin.training.classify.export_onnx import export_onnx
from plugin.plugins.cosplay_plugin.training.classify.model import GameScreenCNN
from plugin.plugins.cosplay_plugin.training.data.dataset import GALGAME_SCREEN_LABELS, GameScreenDataset


_LOGGER = logging.getLogger(__name__)
DEFAULT_OUTPUT_DIR = "plugin/plugins/cosplay_plugin/models/vision/screen_classifier"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train the cosplay screen classifier CNN")
