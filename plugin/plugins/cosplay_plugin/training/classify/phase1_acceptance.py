...
from plugin.plugins.cosplay_plugin.core.vision.labels import (
    vision_label_to_screen_type,
)
from plugin.plugins.cosplay_plugin.core.vision.preprocessing import (
    IMAGENET_MEAN,
    IMAGENET_STD,
    softmax,
)
from plugin.plugins.cosplay_plugin.models import OCR_CAPTURE_PROFILE_STAGE_DEFAULT
from plugin.plugins.cosplay_plugin.screen_awareness_training import (
    ScreenAwarenessTrainingSample,
    build_prototype_model,
)
from plugin.plugins.cosplay_plugin.screen_classifier import (
...
DEFAULT_MODEL_DIR = "plugin/plugins/cosplay_plugin/models/vision/screen_classifier"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    acceptance.add_argument("--data-dir", default="plugin/plugins/cosplay_plugin/training/data")
    acceptance.add_argument("--model-path", default=f"{DEFAULT_MODEL_DIR}/v1_cosplay.onnx")
    ...
    coverage.add_argument(
        ...
        default=[
            ...
            "plugin/plugins/cosplay_plugin/ocr_capture_backends/_helpers.py",
            "plugin/plugins/cosplay_plugin/ocr_manager_capture.py",
            "plugin/plugins/cosplay_plugin/ocr_manager_runtime.py",
            "plugin/plugins/cosplay_plugin/ocr_reader.py",
            "plugin/plugins/cosplay_plugin/ocr_runtime_types.py",
            "plugin/plugins/cosplay_plugin/service/__init__.py",
        ],
    )
    coverage.add_argument(
        ...
        default=[
            "-q",
            "plugin/tests/unit/plugins/test_cosplay_rapidocr_support.py",
            "plugin/tests/unit/plugins/test_cosplay_ocr_reader.py::test_background_hash_excludes_bottom_dialogue_region",
            "plugin/tests/unit/plugins/test_cosplay_ocr_reader.py::test_ocr_capture_keeps_full_frame_for_vision_classifier",
            "plugin/tests/unit/plugins/test_cosplay_ocr_reader.py::test_ocr_reader_runtime_groups_fields_and_keeps_flat_compatibility",
            "plugin/tests/unit/plugins/test_cosplay_ocr_reader.py::test_ocr_reader_build_runtime_exposes_vision_classifier_status",
            "plugin/tests/unit/plugins/test_cosplay_ocr_reader.py::test_ocr_reader_logs_when_vision_classifier_loads",
            "plugin/tests/unit/plugins/test_cosplay_service.py::test_status_payload_exposes_vision_classifier_runtime",
            "--basetemp",
