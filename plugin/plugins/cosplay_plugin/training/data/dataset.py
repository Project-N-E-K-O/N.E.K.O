...
from plugin.plugins.cosplay_plugin.core.vision.labels import GALGAME_VISION_LABELS
from plugin.plugins.cosplay_plugin.training.shared.augment import build_eval_transform, build_train_transform
