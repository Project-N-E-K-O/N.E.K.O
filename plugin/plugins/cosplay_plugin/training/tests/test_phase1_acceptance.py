...
from plugin.plugins.cosplay_plugin.core.vision.labels import vision_label_to_screen_type
from plugin.plugins.cosplay_plugin.training.classify import phase1_acceptance
from plugin.plugins.cosplay_plugin.training.classify.phase1_acceptance import (
...
def test_label_to_stage_maps_cosplay_labels_to_runtime_stages() -> None:
