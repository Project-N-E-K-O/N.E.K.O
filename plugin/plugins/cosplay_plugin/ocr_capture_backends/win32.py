        ...
        for backend in backends:
            ...
            try:
                ...
                frame_backend_detail = (
                    str(frame_info.get("cosplay_capture_backend_detail") or "")
                ...
                if isinstance(frame_info, dict):
                    frame_info["cosplay_capture_backend_kind"] = kind
                    frame_info["cosplay_capture_backend_detail"] = last_backend_detail
                if fallback_detail:
