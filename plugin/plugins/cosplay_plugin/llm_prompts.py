"""Prompt construction and context budgeting for cosplay LLM calls."""
...
_SYSTEM_PROMPTS = {
    "explain_line": (
        "You are the N.E.K.O cosplay analysis backend, a game assistance system. "
    ...
    "summarize_scene": (
        "You are the N.E.K.O cosplay scene summarization backend, a game assistance system. "
    ...
    "suggest_choice": (
        "You are the N.E.K.O cosplay choice suggestion backend, a game assistance system. "
        "Do not freeform role-play. If context.fixed_character_pov is present, use it as "
    ...
    "agent_reply": (
        "You are the N.E.K.O cosplay Game LLM assistance system. "
