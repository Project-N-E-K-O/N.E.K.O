...
from plugin.sdk_v2.shared.constants import HOOK_META_ATTR
...
class HookHandler(Protocol):
    def __call__(self, target: str, payload: JsonObject) -> Awaitable[Result[JsonObject | JsonValue, Exception]]: ...
