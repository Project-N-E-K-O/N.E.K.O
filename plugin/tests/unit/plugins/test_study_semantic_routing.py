...
def test_unknown_subject_must_not_supply_graph_retrieval_concepts() -> None:
    assert parse_study_input_semantics(
        _valid_payload(subject="unknown", content_type="unknown", intent="unknown", entity="", retrieval_concepts=[], confidence=0.2)
    ) == StudyInputSemantics(subject="unknown", content_type="unknown", intent="unknown", entity="", retrieval_concepts=(), confidence=0.2)
