...
/**
 * Clear authentication state and redirect the user to the login page.
 *
 * Clears stored authentication code, navigates to '/login', and closes all Element Plus messages.
 * If the authentication store is not initialized, a debug message is logged.
 */
